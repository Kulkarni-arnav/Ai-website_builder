...
export const createUserProject = async (req: Request, res: Response) => {
    ...
    try {
            ...
            messages:[
                {
                    ...
                    content: `You are a prompt enhancement specialist. Take the user's website request and expand it into a detailed, comprehensive prompt that will help create the best possible website.
                              ...
                              2.Specifing key features and sections.
                              3. Describing the user experience and interactions.
                              4. Mentioning responsive design requirements.
                              5. Adding any missingbut important details.
                              
                              Return ONLY the enhanced prompt, nothing else. Make it detailed but concise (2-3 paragraphs max).`
                },
                {
                    role:'user',
                    content: `Enhance this user prompt for a website builder application: ${initial_prompt}`
                }
            ]
        })
        ...
        await prisma.conversation.create({
            data:{
                role: 'assistant',
                content: `Your website has been generated successfully! You can preview it and request changes as needed.`,
                projectId: project.id
            }
        })
