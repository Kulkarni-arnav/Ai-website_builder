    ...
    try {
        ...
        const promptEnhanceResponse = await openai.chat.completions.create({
            ...
            messages:[
                ...
                {
                    role:'user',
                    content: `User's original request: "${message}"`
                }
            ]
        ...
        await prisma.conversation.create({
            data:{
                role: 'assistant',
                content: `Now making changes to you website: "${enhancedPrompt}".`,
                projectId: currentProject.id
            }
        })
        ...
        await prisma.conversation.create({
            data:{
                role: 'assistant',
                content: "I have made the changes to your website. Here is the updated code.",
                projectId: currentProject.id
            }
        })
