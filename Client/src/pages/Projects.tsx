        ...
        <div className='flex max-sm:flex-col sm:items-center gap-4 px-4 py-2 no-scrollbar'>
          ...
          <div className='flex items-center gap-2 sm:min-w-90 text-nowrap'>
            ...
            <div className='sm:hidden flex-1 flex justify-end'>
              {isMenuOpen 
              ? <MessagesSquareIcon  className='size-6 cursor-pointer' onClick={()=>setIsMenuOpen(false)}/> 
          ...
          <div className='flex items-center justify-end gap-3 flex-1 text-xs sm:text-sm'>
                ...
                <button onClick={downloadCode} className='bg-linear-to-br from-blue-600 to-blue-600 hover:from-blue-600 hover:to-blue-500 text-white px-3.5 py-1 flex items-center gap-2 rounded sm:rounded-sm transition-colors'> 
                 <ArrowBigDownDashIcon size={16} /> Download</button>
                <button onClick={togglePublish} className='bg-linear-to-br from-indigo-600 to-indigo-600 hover:from-indigo-600 hover:to-indigo-500 text-white px-3.5 py-1 flex items-center gap-2 rounded sm:rounded-sm transition-colors'> 
